...
func (ec *executionContext) _Query_tweets(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*Tweet)
	fc.Result = res
	return ec.marshalOTweet2ᚕᚖtwitterᚋgraphᚐTweetᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalOTweet2ᚕᚖtwitterᚋgraphᚐTweetᚄ(ctx context.Context, sel ast.SelectionSet, v []*Tweet) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	ret := make(graphql.Array, len(v))
